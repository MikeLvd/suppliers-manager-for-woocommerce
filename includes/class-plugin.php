...
class Plugin
{
    ...
    {
        $this->version = defined('SMFW_VERSION') ? SMFW_VERSION : '3.0.2';
    ...
    private function define_admin_hooks(): void
    {
        ...
        $this->loader->add_filter('bulk_actions-edit-product', $admin, 'add_product_bulk_actions');
        $this->loader->add_filter('handle_bulk_actions-edit-product', $admin, 'handle_product_bulk_actions', 10, 3);
        $this->loader->add_action('admin_menu', $admin, 'add_bulk_edit_page');
        $this->loader->add_action('admin_post_smfw_process_bulk_edit', $admin, 'process_bulk_edit_suppliers');
        $this->loader->add_action('admin_notices', $admin, 'display_bulk_edit_notices');
    }
